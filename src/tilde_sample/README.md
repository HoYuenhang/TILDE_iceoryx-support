...
```
CYCLONEDDS_URI=file://$PWD/cyclonedds.xml ros2 run tilde_sample publish_without_stamp_loaned
CYCLONEDDS_URI=file://$PWD/cyclonedds.xml ros2 run tilde_sample relay_timer_loaned
```
